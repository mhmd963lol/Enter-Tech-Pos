  ...
  return (
    <div className="flex flex-col h-[calc(100vh-7rem)] min-h-0" dir="rtl">
      <div className="flex flex-col lg:flex-row gap-4 flex-1 min-h-0 overflow-hidden">
        ...
        <motion.div
          layout
          className={`flex-1 flex flex-col bg-white dark:bg-zinc-950 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${settings.masterTheme === "ios-glass" ? "glass-panel" : ""} ${isCartOpen ? "lg:w-auto" : "lg:w-full"}`}
        >
          <div className="p-4 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 flex-1">
              <button
                ...
                className={`p-3 rounded-xl transition-all border shrink-0 ${isCategorySidebarOpen ? "bg-indigo-50 border-indigo-200 text-indigo-600 shadow-inner" : "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-800"}`}

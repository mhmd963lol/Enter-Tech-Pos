            ...
            >
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Disable Animations (Speed Mode) */}
                  <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-900/50 rounded-xl border border-zinc-200 dark:border-zinc-800 transition-all hover:border-indigo-300 dark:hover:border-indigo-700">
                    <div className="flex items-center gap-3">
                      <Zap className="w-5 h-5 text-amber-500" />
                      <div>
                        <p className="font-bold text-zinc-900 dark:text-white">وضع السرعة (تعطيل الحركات)</p>
                        <p className="text-sm text-zinc-500 dark:text-zinc-400">لأداء أسرع على الأجهزة الضعيفة</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        className="sr-only peer"
                        checked={localSettings.disableAnimations}
                        onChange={(e) =>
                          setLocalSettings({
                            ...localSettings,
